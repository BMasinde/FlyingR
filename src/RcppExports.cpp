...
// minpowspeed_cpp
NumericVector minpowspeed_cpp(NumericVector bm, NumericVector ws, NumericVector ipf, double g, NumericVector airDensity, NumericVector bdc);
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< NumericVector >::type ipf(ipfSEXP);
    Rcpp::traits::input_parameter< double >::type g(gSEXP);
    Rcpp::traits::input_parameter< NumericVector >::type airDensity(airDensitySEXP);
    Rcpp::traits::input_parameter< NumericVector >::type bdc(bdcSEXP);
    rcpp_result_gen = Rcpp::wrap(minpowspeed_cpp(bm, ws, ipf, g, airDensity, bdc));
    return rcpp_result_gen;
END_RCPP
}
// total_Mech_Pow_cpp
NumericVector total_Mech_Pow_cpp(NumericVector bm, NumericVector ws, NumericVector wa, NumericVector vt, double g, NumericVector airDensity, NumericVector ipf, NumericVector bdc, double ppc);
