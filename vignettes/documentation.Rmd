...
Breguet equations assume that lift:drag ratio remains constant through out the flight. This becomes appropriate for fixed wing aircraft. However, birds are known to consume part of the engine (convert protein in flight muscles to fuel). This leads to an increase in lift:drag ratio during the flight and thus, an increase in flight range. In the methods discussed above, compensation for this is done by adding 10% of fuel to the lift:drag ratio (method 1) or averaging lift:drag ratio before start of flight and at the end of flight (method 2) Pennycuick cites studies which found that protein is replenished faster during short stop-overs compared to fat mass.

Also, initial climb, and all other flight styles other than continous wing flapping are not accounted for. 
