...
---
```{r packs, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
library(knitr)
library(kableExtra)
library(dplyr)
library(captioner)
...
data("birds")
kable(birds, caption = "Preset birds from Flight program")
```
...
sp <- kable(comparison, caption = "Small Passerines range comparison (10% protein)")
add_footnote(sp, 
...
sp <- kable(comparison, caption = "Small Passerines range comparison (5% protein)")
add_footnote(sp, 
             c("Flight.constant speed = hold speed constant",
             "Flight.V:Vmp constant = Hold ratio V:Vmp constant.",
...
sp <- kable(comparison, caption = "Other birds, range comparison (10% protein)")
add_footnote(sp, 
...
sp <- kable(comparison, caption = "Other birds, range comparison (5% protein)")
add_footnote(sp, 
             c("Birds with bodymass > 50 grams (both passerines and non-passerines)",
               "Flight.constant speed = hold speed constant",
             "Flight.V:Vmp constant = Hold ratio V:Vmp constant.",
